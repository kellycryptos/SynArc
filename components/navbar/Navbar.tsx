  ...
  return (
    <header className="sticky top-0 z-30 glass border-b border-border-thin h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
      <div className="flex items-center gap-4">
        <button className="md:hidden p-2 -ml-2 text-muted hover:text-foreground transition-colors" onClick={onMenuClick}>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
         <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full border border-border-thin bg-surface text-xs font-medium">
           <div className="w-2 h-2 rounded-full bg-arc-blue animate-pulse" />
           <span className="text-muted">Arc Testnet</span>
         </div>
         <button className="relative p-2 text-muted hover:text-foreground transition-colors rounded-full hover:bg-surface-elevated border border-transparent hover:border-border-thin">
