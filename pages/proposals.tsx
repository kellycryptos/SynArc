        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <button 
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-primary text-white font-semibold text-sm hover:bg-primary/90 transition-all shadow-[0_0_15px_rgba(124,58,237,0.2)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {initialProposals.length === 0 ? (
            <GlassCard className="p-8 flex flex-col items-center justify-center">
              <EmptyState 
                ...
                description="There are currently no active or past governance proposals in the SynArc DAO ecosystem." 
              />
            </GlassCard>
          ) : (
                      ...
                      <div className="flex-1 space-y-4">
                        <div className="flex items-center gap-3">
                          <span className={`text-xs px-3 py-1 rounded-full font-semibold border ${
                            ...
                            proposal.status === 'Passed' || proposal.status === 'Executed' ? 'bg-primary/10 border-primary/20 text-purple-400' :
                      ...
                      <div className="w-full md:w-72 space-y-4 md:border-l md:border-border-thin md:pl-6 shrink-0 flex flex-col justify-between">
                        ...
                        {isProposalActive ? (
                          userVoteRecord ? (
                            ...
                            <div className="pt-2 text-center text-xs text-amber-400 font-medium bg-amber-500/5 border border-amber-500/20 rounded-xl py-2">
...
Payload verified by Arc Security layers.`}
              ...
              <div className="space-y-4 pt-3 border-t border-border-subtle">
                ...
                {signingStep === "error" && (
                  <div className="p-3.5 bg-danger/10 border border-danger/20 rounded-2xl flex items-center gap-3 text-xs text-danger flex-wrap">
                ...
                {signingStep === "completed" && (
                  <div className="space-y-3.5">
                    <div className="p-3.5 bg-success/10 border border-success/20 rounded-2xl flex items-center gap-3 text-xs text-emerald-400 font-bold">
                      <Check className="w-4.5 h-4.5 animate-bounce text-success shrink-0" />
