    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden px-4">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold font-heading tracking-tight mb-6 leading-tight text-text-primary animate-fade-in-up" style={{ animationDelay: "100ms" }}>
          ...
          <p className="text-xl md:text-2xl text-text-secondary max-w-3xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: "200ms" }}>
